            ...
            <div className="content-container">
                <div className="header">
                    ...
                    <img className="social-1" src={discord} /> 
                        <a href="https://t.me/ep_code_1"><img className="social-2" src={telegram} /></a>
                        <a href="https://www.instagram.com/saifaliabdulhey87/"><img className="social-3" src={instagram} /></a>
                    </div>
                </div>
            </div>
        </header>
